...
public class ImageTest {
    ...
    public static void main(String[] args) throws Exception {
        DefaultProfile profile = DefaultProfile.getProfile(
                "cn-shanghai",             //默认
                "LTAI4G1a9jwwXfvRfRgyzeZ3",         //您的AccessKeyID
                "P7HsAukeZxjQiJHMV64H6m8WVg6Npg");    //您的AccessKeySecret
    ...
    public static void testRecognizeDriverLicense() throws Exception {
        ...
        req.setSide("face");
        // 注意：下面的链接换成自有的oss链接
        req.setImageURL("https://hjjimg.oss-cn-shanghai.aliyuncs.com/%E9%A9%BE%E9%A9%B6%E8%AF%81.png");
    ...
    public static void testRecognizeDrivingLicense() throws Exception {
        ...
        req.setSide("face");
        // 注意：下面的链接换成自有的oss链接
        req.setImageURL("https://java-tx.oss-cn-shanghai.aliyuncs.com/111/Snipaste_2020-08-18_10-04-08.jpg");
